      ...
      <div className="relative flex transform-gpu snap-x snap-mandatory gap-4 overflow-x-auto">
        ...
        {tweet.photos.map((photo) => (
          <img
            ...
            alt={tweet.text}
            className="flex-shrink flex-basis rounded-xl border object-cover shadow-sm overflow-y-auto"
          />
        ))}
        <div className="shrink-0 snap-center sm:w-2" />
      </div>
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex size-full flex-col gap-0 overflow-hidden rounded-lg border p-4 backdrop-blur-md",
        className,
      )}
      {...props}
    >
